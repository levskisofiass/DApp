...
contract('ExchangeOracle', function(accounts) {
    ...
    describe("creating contract", () => {
        it("should be able to deploy Lockchain Oracle Contract", async function() {
            ...
            assert.isDefined(ExchangeOracleInstance, "Could not deploy Lockchain Oracle contract");
        })
    })
    ...
    describe("constructor", () => {
        ...
        it("should have been set as oracle", async function() {
            const isOracle = await ExchangeOracleInstance.isLocOracle.call();
